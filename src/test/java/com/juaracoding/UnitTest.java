...
public class UnitTest {
    ...
    public void input_data_unit_valid(){
        unitPage.setDataTambahkanUnit("aaatest farhan", "Cuti Bersama", "Aturan Cuti Test");
    }
    ...
    public void input_data_unit_tanpa_mengisi_nama_unit(){
        ...
        unitPage.setAturanCuti("Aturan Cuti Test");
        DriverSingleton.delay(1);
    ...
    public void menampilkan_nama_unit_yang_dicari(){
        DriverSingleton.delay(2);
        System.out.println(unitPage.getDataNamaUnit());
        System.out.println(unitPage.getInformationPage());
    }
