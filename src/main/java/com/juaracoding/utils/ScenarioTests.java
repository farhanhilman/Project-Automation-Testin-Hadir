...
public enum ScenarioTests {
    ...
    T38("Verifikasi tombol 'batal delete' pada salah satu shift"),
    T39("Verifikasi tombol 'delete' pada salah satu shift"),
    ...
    T59("Melakukan pencarian device berdasarkan nama"),
    T60("Melakukan reset data yang sudah difilter"),
    T61("Melakukan pencarian device berdasarkan nama yang tidak terdata"),
    T62("Successfull login user with valid credentials"),
    T63("Failed login user with invalid email"),
    T64("Failed login user with invalid email not input symbol '@'"),
    T65("Failed login user with invalid password"),
    T66("Failed login user without input password"),
    T67("Failed login user witout input email"),
    T68("Failed login user without email and password");
